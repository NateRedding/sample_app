...
describe User do
  ...
  describe "password encryption" do
    ...
    describe "has_password? method" do
      ...
      describe "authenticate method" do
        ...
        it "should return nill for an e-mail address with no user" do
  ...
  describe 'micropost associations' do
    ...
    it 'should order microposts in the right order' do
  ...
  describe 'relationship associations' do
    ...
    it "should hava a reverse_relationships method" do
    ...
    it "should include the follower user in the user.followers array" do
      @user.follow!(@followed)
