...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    describe "when signed in as another user" do
      it "should be successful" do
        controller.sign_in(FactoryGirl.create(:user, :email => FactoryGirl.generate(:email)))
        get :show, :id => @user
        response.should be_success
      end
    end
  ...
  describe "PUT " do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "New Name", :email => "new.mail@example.com", :password => "bazquux", :password_confirmation => "bazquux" }
      end

      it "should change the user's attributes" do
        put(:update, :id => @user, :user => @attr)
        user = assigns(:user)
        @user.reload  # updates user from db
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should redirect to the uses page" do
        delete :destroy, :id => @user
  ...
  describe "follow pages" do
    describe "when not signed in" do
      ...
      it "should project followers" do
        get :followers, :id => 1
        response.should redirect_to(signin_path)
